...
import 'package:Jollibee/view/shop/shop.dart';
import 'package:Jollibee/viewmodels/user_view_model.dart';
        ...
        children: [
          UICardHome(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const ListPromotionScreen()),
            ),
          ...
          UICardHome(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const MenuFoodScreen()),
            ),
            color: AppColors.primaryColor,
          ...
          UICardHome(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const RencentOrderScreen()),
            ),
            color: AppColors.primaryColor,
